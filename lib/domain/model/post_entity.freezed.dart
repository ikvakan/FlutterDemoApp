...
class _$_PostEntity implements _PostEntity {
  ...
  @override
  String toString() {
    return 'PostEntity(id: $id, title: $title, summary: $summary, imageUrl: $imageUrl, isFavorite: $isFavorite)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, summary, imageUrl, isFavorite);
...
abstract class _PostEntity implements PostEntity {
  const factory _PostEntity(
      ...
      final bool isFavorite}) = _$_PostEntity;
